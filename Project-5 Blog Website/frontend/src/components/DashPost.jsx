                ...
                <div className="dash-title-right-upper flex justify-between">
                    ...
                    <div className="flex gap-4 justify-center items-center">
                        ...
                        <button onClick={handleDelete}>
                            <svg className="hover:bg-gray-700 rounded-full p-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="30" height="30" color="#F54927" fill="none" stroke="#F54927" strokeWidth="1.5" strokeLinecap="round">
